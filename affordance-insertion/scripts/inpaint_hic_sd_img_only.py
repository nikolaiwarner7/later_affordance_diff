...
# Current path
MODEL_PATH =  '/coc/flash3/nwarner30/image_editing/affordance-insertion/logs/2024-04-17T15-51-05_affordance/checkpoints/epoch=000390-v1.ckpt'
...
""" 4_25 debugging merged lmdb shards
"""
#DATA_PATH = '/srv/essa-lab/flash3/nwarner30/image_editing/affordance-insertion/preprocessing_data/4_25_Kinetics_shard0_test'
#DATA_PATH = '/srv/essa-lab/flash3/nwarner30/image_editing/affordance-insertion/preprocessing_data/4_25_NTU_shard_test'
#DATA_PATH = '/srv/essa-lab/flash3/nwarner30/image_editing/affordance-insertion/preprocessing_data/kinetics_full_4_11_to_merge'
#DATA_PATH = '/srv/essa-lab/flash3/nwarner30/image_editing/affordance-insertion/preprocessing_data/final_merged_kinetics_full_4_11/validation_data'


# specify data to do inf on
...
TRAIN_PATH =  '/srv/essa-lab/flash3/nwarner30/image_editing/affordance-insertion/full_kinetics_data_our_sampling_3_18/training_data/kinetics'  
            ...
            for batch_idx, batch in tqdm(enumerate(dataset)):
                ...
                for cfg_scale in [CFG_SCALE ]:
                    ...
                    for idx in range(1):
                        ...
                        # Add pose
                        cond_dict_sdm['crossattn']['frame_pose_target'] = torch.zeros_like(model.cond_pose_model.encode(batch["frame_pose_target"])).cuda()
                        cond_dict_sdm['crossattn']['frame_pose_refer'] = torch.zeros_like(model.cond_pose_model.encode(batch["frame_pose_refer"])).cuda()
                        ...
                        cond_dict_sdm['crossattn']['frame_pose_target'] = torch.zeros_like(model.cond_pose_model.encode(uncond_frame_pose_target).repeat(INFERENCE_BATCH_SIZE, 1, 1)).cuda()
                        cond_dict_sdm['crossattn']['frame_pose_refer'] = torch.zeros_like(model.cond_pose_model.encode(uncond_frame_pose_refer).repeat(INFERENCE_BATCH_SIZE, 1, 1)).cuda()
