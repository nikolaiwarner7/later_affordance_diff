...
MODEL_PATH = '/coc/flash3/nwarner30/image_editing/affordance-insertion/logs/2024-04-23T16-37-22_affordance/checkpoints/epoch=000390.ckpt'
            ...
            for batch_idx, batch in tqdm(enumerate(dataset)):
                ...
                for cfg_scale in [CFG_SCALE ]:
                    ...
                    for idx in range(1):
                        ...
                        # Define unconditional poses, then encode
                        ...
                        #uncond_frame_pose_refer = torch.zeros((INFERENCE_BATCH_SIZE,18,3)).cuda()
